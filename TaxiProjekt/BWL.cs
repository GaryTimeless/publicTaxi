...
namespace TaxiProjekt
{
    public class BWL
    {
        ...
        //Hack auf den ersten Blick würde ich sagen, es wäre auch cool, wenn man immer den Wert einer Zahl zurück geben würde. |x|. wenn das schon so ist Bitte löschen ^^
